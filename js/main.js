...
p1.createControl = function(xhh) {
    ...
    try {
        ...
        //JHS xjh.appendChild(x3e);
        this.x0f = x3e
        var xwc = this;
        // JHS - Mouse click on pano right/left
        xYe.addEventListener("mousedown", function(xfe) {
            return xwc.xf(xfe ? xfe : window.event)
        }, false);
        window.addEventListener("resize", function(xfe) {
            return xwc.xM(xfe ? xfe : window.event)
        }, false);
        document.addEventListener("mousemove", function(xfe) {
            return xwc.xQe(xfe ? xfe : window.event)
        }, false);
        document.addEventListener("mouseup", function(xfe) {
            return xwc.xuc(xfe ? xfe : window.event)
        }, false);

        document.addEventListener("keydown", function(xfe) {
            return xwc.xy(xfe ? xfe : window.event)
        }, false);
        document.addEventListener("keyup", function(xfe) {
            return xwc.xVf(xfe ? xfe : window.event)
        }, false);
        if (this.xmc) {
            xYe.addEventListener("touchstart", function(xfe) {
                return xwc.xBd(xfe ? xfe : window.event)
            }, false);
            xYe.addEventListener("touchmove", function(xfe) {
                return xwc.xDe(xfe ? xfe : window.event)
            }, false);
            xYe.addEventListener("touchend", function(xfe) {
                return xwc.xvd(xfe ? xfe : window.event)
            }, false);
        }
        x9b.addEventListener("click", function(xfe) {
            return xwc.x0d(xfe ? xfe : window.event)
        }, false);
        x9b.addEventListener("mouseover", function(xfe) {
            this.style.opacity = 0.5
        }, false);
        x9b.addEventListener("mouseout", function(xfe) {
            this.style.opacity = 0.2
        }, false);
        xph.addEventListener("mouseover", function(xfe) {
            this.style.opacity = 0.5
        }, false);
        xph.addEventListener("mouseout", function(xfe) {
            this.style.opacity = 0.2
        }, false);
        ...
        xjh.addEventListener("click", function(xfe) {
            xwc.xb(false);
        }, false);
        ...
        if (this.xUc) {
            xYe.addEventListener("webglcontextlost", function(xfe) {
                return xwc.xs(xfe ? xfe : window.event)
            }, false);
            xYe.addEventListener("webglcontextrestored", function(xfe) {
                return xwc.xTe(xfe ? xfe : window.event)
            }, false);
        }
        var xD = document.createElement("img");
        xD.style.visibility = "hidden";
        if (document.addEventListener) {
            xD.addEventListener("load", function(xfe) {
                return xwc.x0c(xfe ? xfe : window.event)
            }, false);
            xD.addEventListener("error", function(xfe) {
                return xwc.xN(xfe ? xfe : window.event)
            }, false);
        } else if (document.attachEvent) {
            xD.attachEvent("onload", function(xfe) {
                return xwc.x0c(xfe ? xfe : window.event)
            });
            xD.attachEvent("onerror", function(xfe) {
                return xwc.xN(xfe ? xfe : window.event)
            });
        }
        this.xTc = xD;
        ...
        if (this.xFe) {
            ...
            window.addEventListener("devicemotion", function(xfe) {
                return xwc.xoe(xfe ? xfe : window.event)
            }, false);
        }
        document.addEventListener("mozfullscreenchange", function(xfe) {
            return xwc.xWe()
        }, false);
        document.addEventListener("webkitfullscreenchange", function(xfe) {
            return xwc.xWe()
        }, false);
        document.addEventListener("fullscreenchange", function(xfe) {
            return xwc.xWe()
        }, false);
        this.xWd();
    } catch (xpb) {
...
p1.xW = function(event) {
    {
        ...
        if (this.xUc) {
            ...
            nhPanoramaViewer.requestAnimationFrame(function() {
                xwc.xW(null)
            }, this.xRb);
        } else {
            setTimeout(function() {
...
nhPanoramaViewer.has3dCss = function() {
    ...
    if (!xRg) return false;
    if (typeof xRg.style.webkitPerspective == "string") {} else if (typeof xRg.style.MozPerspective == "string") {} else return false;
...
function xEj(xZi, xzj, xze, xKb, xif, xIc, xIh) {
    ...
    if (document.addEventListener) {
        xD.addEventListener("load", function(xfe) {
            return xwc.xCi(xfe ? xfe : window.event)
        }, false);
        xD.addEventListener("error", function(xfe) {
            return xwc.xBi(xfe ? xfe : window.event)
        }, false);
    } else if (document.attachEvent) {
        xD.attachEvent("onload", function(xfe) {
            return xwc.xCi(xfe ? xfe : window.event)
...
function xTk(value) {
    ...
    if ((xpm == "undefined") || (value === null)) {} else if (xpm == "number") {
        this.xGk(value);
    } else if (xpm == "string") {
        this.xRk(value);
    } else if (xpm == "object") {
